...
<head>
  ...
  <meta name="color-theme" content="#0d6efd">
  ...
  <!-- Dark and light CSS bootstrap -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-dark-5@1.0.2/dist/css/bootstrap-night.min.css" media="(prefers-color-scheme: dark)" rel="stylesheet" id="dark-style">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-dark-5@1.0.2/dist/css/bootstrap.min.css" rel="stylesheet" id="light-style">
  ...
  <main>
    ...
    <div class="container-fluid bg-dark text-light row justify-content-center" id="contact" style="margin:0">
        ...
        <div class="row justify-content-center g-5">
          <!--
          <div class="col-auto">
            <a href="" class="d-flex flex-column text-decoration-none text-light text-wrap">
              <i class="bi bi-envelope-fill fs-1 align-self-center"></i>
              <span class="fs-4 align-self-center">Courriel</span>
            </a>
          </div>
          <div class="col-auto">
            <a href="#" class="d-flex flex-column text-decoration-none text-light text-wrap">
              <i class="bi bi-telephone-fill fs-1 align-self-center"></i>
              <span class="fs-4 align-self-center">Téléphone</span>
            </a>
          </div>
          -->
          <div class="col-auto">
    ...
    <button type="button" id="darkButton" class="btn btn-dark btn-lg rounded-circle position-fixed bottom-0 end-0 m-5"><i class="bi bi-moon"></i></button>
  </main>
  <footer>
    <div class="container-fluid bg-dark text-light text-center p-3">
      <div class="row">
        ...
        <div class="col-xs-12 col-md-6 text-md-center" id="realised">
          Réalisé par&nbsp
        </div>
